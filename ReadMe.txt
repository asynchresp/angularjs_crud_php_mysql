Author: Ralny
Author URL: https://github.com/Ralny/
Author Email: ra@trivee.com.br

============ Instruction ============
1. Create a database (for example, algularjs_crud) and import the "users.sql" file into this database.
